...
unstructured 'C<data>' messages which each include some bytes of data.
L<Mixin classes|gear_mixins> provide common routines for piping data in
...
declare their properties like this:
...
The package name for your gear class must be of the form:

  Sprog::Gear::YourClass
